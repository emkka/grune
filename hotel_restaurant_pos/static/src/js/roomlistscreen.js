        ...
        render_room_list(rooms) {
            ...
            for (var i = 0, len = Math.min(rooms.length, 1000); i < len; i++) {
                ...
                if (checkin_dt <= current_date && checkout_dt >= current_date) {
                    ...
                    rooms[i]['checkin_dt'] = moment(checkin_dt).format('DD-MMM-YYYY HH:mm');
                    rooms[i]['checkout_dt'] = moment(checkout_dt).format('DD-MMM-YYYY HH:mm');
                    if (room) {
